...
_kcs_logger_normalize() {
  ...
  local input="$1"
  input="${input//$_KCS_CORE_PATH/\$KCS_CORE_PATH}"
  input="${input//$_KCS_PLUGIN_PATH/\$KCS_PLUGIN_PATH}"
  input="${input//$_KCS_ROOT_PATH/\$KCS_ROOT_PATH}"
  input="${input//$_KCS_CURR_PATH/\$KCS_CURR_PATH}"
